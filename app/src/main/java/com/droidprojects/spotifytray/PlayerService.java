    ...
    public void onCreate() {
        ...
        mRootLayout.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                is = null;
                try {
                    is = getAssets().open(mPlaylist.getCurrentSongInfo().getMAlbumCoverPath());
                } catch (IOException e) {
                    e.printStackTrace();
                }
                ...
                mSongTitleView.setText(mPlaylist.getCurrentSongInfo().getMTitle());
                mSingerView.setText(mPlaylist.getCurrentSongInfo().getMSinger());
